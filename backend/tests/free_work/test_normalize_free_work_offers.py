...
import backend.scripts.normalize_free_work_offers as normalize_module
from backend.scripts.normalize_free_work_offers import normaliser_competences, normaliser_offres
...
def test_normalize_nominal_and_idempotence(tmp_path, capsys, monkeypatch):
    ...
    monkeypatch.setattr(normalize_module, "PROCESSED_DATA_ROOT", data_root / "processed")
    ...
    assert output_dir == data_root / "processed" / "free_work" / "normalized" / "batch_test"
