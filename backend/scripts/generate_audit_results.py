...
def main():
    ...
    fw_input_path = PROCESSED_DATA_ROOT / "free_work" / "full_catalog" / "20260624_081715" / "offers_normalized.json"
    ft_input_path = PROCESSED_DATA_ROOT / "france_travail" / "snapshots" / "current" / "france_travail_offers_snapshot.json"
    ...
    for fw_sid, fw_item in fw_by_id.items():
        ...
        # Source trace
        source_trace = {
            "free_work_input_file": "backend/data/processed/free_work/full_catalog/20260624_081715/offers_normalized.json",
            "free_work_source_id": fw_sid,
            "france_travail_input_file": "backend/data/processed/france_travail/snapshots/current/france_travail_offers_snapshot.json",
