...
def create_output():
    """Crée le fichier backend/data/processed/merged_data.csv à partir des données brutes.
    ...
    raw_data_folder = os.getenv("RAW_DATA_FOLDER", str(RAW_DATA_ROOT))
    processed_data_folder = os.getenv("PROCESSED_DATA_FOLDER", str(PROCESSED_DATA_ROOT))
