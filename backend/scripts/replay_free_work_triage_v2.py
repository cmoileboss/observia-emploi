...
def main():
    ...
    source_dir = PROCESSED_DATA_ROOT / "matching" / "free_work_vs_france_travail" / args.source_run_id
    target_dir = PROCESSED_DATA_ROOT / "matching" / "free_work_vs_france_travail" / args.target_run_id
    raw_offers_path = RAW_DATA_ROOT / "free_work" / "full_catalog" / "batches" / "20260624_081715" / "offers_deduplicated.json"
    normalized_offers_path = PROCESSED_DATA_ROOT / "free_work" / "full_catalog" / "20260624_081715" / "offers_normalized.json"
    france_travail_snapshot_path = PROCESSED_DATA_ROOT / "france_travail" / "snapshots" / "current" / "france_travail_offers_snapshot.json"
