...
from scripts.analyze_free_work_ambiguities import (
    AnalysisError,
    build_case_metrics,
    build_clusters,
...
def test_validate_inputs_rejects_duplicate_ids(monkeypatch):
    monkeypatch.setattr("scripts.analyze_free_work_ambiguities.EXPECTED_HUMAN_REVIEW_COUNT", 2)
    monkeypatch.setattr("scripts.analyze_free_work_ambiguities.EXPECTED_PRIORITIES", {"LOW": 2})
