...
from scripts.run_free_work_triage_v2 import run_fresh_triage_v2
...
def test_fresh_triage_cli_with_explicit_paths(valid_inputs, tmp_path):
    ...
    completed = subprocess.run(
        [
            sys.executable,
            str(PROJECT_ROOT / "scripts" / "run_free_work_triage_v2.py"),
            "--free-work-input",
            str(fw),
...
def test_no_historical_paths_in_new_script():
    text = (PROJECT_ROOT / "scripts" / "run_free_work_triage_v2.py").read_text(encoding="utf-8")
