...
def main():
    ...
    payload = analyze_intermediaries(
        base,
        PROJECT_ROOT / "data" / "processed" / "free_work" / "full_catalog" / "20260624_081715" / "offers_normalized.json",
        PROJECT_ROOT / "data" / "processed" / "france_travail" / "snapshots" / "current" / "france_travail_offers_snapshot.json",
        args.v1_run_id,
        args.v2_run_id,
    )
